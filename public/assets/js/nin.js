  ...
  <div class="row">
    ...
    <div class="col-12 col-md-4 text-center mb-3 mb-md-0">
      <div class="position-relative d-inline-block">
        <img class="img-fluid rounded shadow-sm border" src="data:${mime};base64, ${result.data.image}" alt="User Image" style="max-width: 200px; height: auto;">
        <div class="mt-2">
           <a href="data:${mime};base64, ${result.data.image}" download="NIN_Image_${result.data.nin}.${ext}" class="btn btn-sm btn-outline-primary w-100">
