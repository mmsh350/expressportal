  ...
  <div class="row align-items-start">
    ...
    <div class="col-12 col-md-4 text-center mb-4 mb-md-0">
      <div class="position-relative d-inline-block p-2 border rounded-3 bg-light">
        ...
        <div class="mt-3">
           <a href="data:${mime};base64, ${result.data.image}" download="NIN_Image_${result.data.nin}.${ext}" class="btn btn-sm btn-primary w-100">
    ...
    <div class="col-12 col-md-8">
      <div class="ps-md-4">
        <div class="row border-bottom py-2 g-0">
          ...
          <div class="col-12 col-sm-7 fw-bold text-primary text-sm-end" id="nin_no">${result.data.nin}</div>
        </div>
        <div class="row border-bottom py-2 g-0">
        ...
        <div class="row border-bottom py-2 g-0">
          ...
          <div class="col-12 col-sm-7 fw-bold text-sm-end">${result.data.surname}</div>
        </div>
        <div class="row border-bottom py-2 g-0">
        ...
        <div class="row border-bottom py-2 g-0">
          ...
          <div class="col-12 col-sm-7 text-sm-end">${result.data.birthdate}</div>
        </div>
        <div class="row border-bottom py-2 g-0">
        ...
        <div class="row border-bottom py-2 g-0">
          ...
          <div class="col-12 col-sm-7 text-sm-end">${result.data.telephoneno}</div>
        </div>
        <div class="row border-bottom py-2 g-0">
        ...
        <div class="row border-bottom py-2 g-0">
          ...
          <div class="col-12 col-sm-7 text-sm-end">${result.data.residence_AdressLine1 ?? ''}</div>
        </div>
      </div>
    </div>
  </div>
