    ...
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin d-flex flex-column">
            <div class="row">
                                    ...
                                    <tbody>
                                        @foreach ($modifications as $mod)
                                            <tr>
                                                ...
                                                <td><span class="badge bg-info text-dark">{{ $mod->type }}</span></td>
                                                <td>{{ $mod->nin }}</td>
                                                <td>
                ...
                <!-- Reply Modal -->
                <div class="modal fade" id="reply" tabindex="-1" aria-labelledby="reply" data-bs-keyboard="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                                ...
                                <form method="POST" id="statusForm">
                                    ...
                                    <div class="mb-3 d-none" id="refundOption">
                                        ...
                                        <div class="d-flex gap-2 mb-2">
                                            <button type="button" class="btn btn-outline-secondary btn-sm refund-pct" data-pct="100">100%</button>
                                            <button type="button" class="btn btn-outline-secondary btn-sm refund-pct" data-pct="50">50%</button>
                                            <button type="button" class="btn btn-outline-secondary btn-sm refund-pct" data-pct="0">0%</button>
                                        </div>
