...
@section('title', 'NIN Delink Validation')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">NIN Delink Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.delink.services.list') }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="staticBackdropLabel2">Reply Delink (#<span id="sid"></span>)</h6>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reply').on('show.bs.modal', function(event) {
                ...
                const requestType = 'delink-services';
