...
@section('title', 'Modification IPE Clearance Details')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Modification IPE Clearance Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                    ...
                                    <div class="card shadow-sm border-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-4">
                                                <div class="p-3 border rounded bg-light">
                                                    <h6 class="text-uppercase mb-3">
                                                        <span class="text-muted">Request Information</span> - Modification IPE Clearance
                                                    </h6>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                            ...
                                            <div class="p-3 border rounded bg-light">
                                                ...
                                                <form action="{{ route('admin.modification.ipe.update-request-status', $requests->id) }}" method="POST" id="statusForm">
                                                    @csrf
