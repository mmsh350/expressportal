                                    ...
                                    <div class="col-md-4">
                                        <form name="ipe-form" id="ipe-form" method="POST"
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-1 mb-2">
                                                ...
                                                @php
                                                    $ipeNotice = \App\Models\SiteSetting::first()->ipe_notice ?? "Our IPE request process is fully automated. You can track the status of your request using the 'Check Status' button";
                                                @endphp
